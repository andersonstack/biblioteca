import "./input.js";
import "./button.js";
import { Livro, LivroDevolucao, LivroEmprestimo } from "../interfaces/livros_api.js";
...
class DevolucaoComponent extends HTMLElement {
    ...
    private render() {
        this.shadow.innerHTML = `
            ...
            <form>
                ...
                <my-input id="titulo-livro" placeholder="Livro" aria-label="ID do Livro"></my-input>
                <h2>UserName do usuário</h2>
                <my-input id="username" placeholder="Usuário" aria-label="ID do usuário"></my-input>
    ...
    private setup() {
        this.shadow.querySelector("my-button#enviar")!.addEventListener(
            "click", async () => {
                const inputTitleLivro = this.shadow.querySelector("my-input#titulo-livro") as HTMLInputElement;
                const inputUsername = this.shadow.querySelector("my-input#username") as HTMLInputElement;
